...
import { PhotoCreateModel, PhotoModel } from "src/app/core/models/photo.model";
...
export const createPhoto = createAction(CREATE_PHOTO, props<{photo: PhotoCreateModel}>())
